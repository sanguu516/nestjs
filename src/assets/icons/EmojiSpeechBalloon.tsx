...
const SvgEmojiSpeechBalloon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#emoji-speech-balloon_svg__a)" d="M0 0h16v16H0z" />
    <defs>
      <pattern
        id="emoji-speech-balloon_svg__a"
        width={1}
        height={1}
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#emoji-speech-balloon_svg__b" transform="scale(.01389)" />
      </pattern>
      <image
        ...
        id="emoji-speech-balloon_svg__b"
        width={72}
        height={72}
      />
    </defs>
...
export default SvgEmojiSpeechBalloon
